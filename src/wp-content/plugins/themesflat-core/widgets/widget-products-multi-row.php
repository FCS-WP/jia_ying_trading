<?php
class TFProductMultiRow_Widget extends \Elementor\Widget_Base {

	public function get_name() {
        return 'tfproductmulti';
    }
    
    public function get_title() {
        return esc_html__( 'TF Product Multi Row', 'themesflat-core' );
    }
    ...
    public function get_style_depends() {
		return ['swiper','swiper-min','tf-product','tf-slide-swiper'];
	}

	public function get_script_depends() {
		return ['swiper-min','countdown','tf-product'];
	}
	...
	protected function register_controls() {
        // Start Posts Query        
	        ...
	        $this->add_control( 
	        	'order_by',
				[
					'label' => esc_html__( 'Order By (Only Recent product)', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'title',
					'options' => [						
			            'date' => 'Date',
			...
			$this->add_control( 
				'order',
				[
					'label' => esc_html__( 'Order (Only Recent Product)', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'asc',
					'options' => [						
			            'desc' => 'Descending',
		...
		// Start Carousel        
	        ...
	        // 	'posts_row',
			// 	[
			// 		'label' => esc_html__( 'Rows', 'themesflat-core' ),
			// 		'type' => \Elementor\Controls_Manager::SELECT,
			// 		'default' => 'row2',
			// 		'options' => [
			// 			'row2' => esc_html__( '2', 'themesflat-core' ),
			// 			'row3' => esc_html__( '3', 'themesflat-core' ),
			// 			'row4' => esc_html__( '4', 'themesflat-core' ),
			// 		],
			// 	]
			// );
			...
			// 		'default' => 'column7',
			// 		'options' => [
			// 			'column1' => esc_html__( '1', 'themesflat-core' ),
			// 			'column2' => esc_html__( '2', 'themesflat-core' ),
			// 			'column3' => esc_html__( '3', 'themesflat-core' ),
			// 			'column4' => esc_html__( '4', 'themesflat-core' ),
			// 			'column5' => esc_html__( '5', 'themesflat-core' ),
			// 			'column6' => esc_html__( '6', 'themesflat-core' ),
			// 			'column7' => esc_html__( '7', 'themesflat-core' ),
			// 		],
			// 		'condition' => [
			// 			'carousel' => 'yes',
			// 		],
			...
			$this->add_control( 
				...
				[
					'label' => esc_html__( 'Columns Mobile (500px - 767px)', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '2',
					'options' => [
						'1' => esc_html__( '1', 'themesflat-core' ),
			...
			$this->add_control( 
	        	'carousel_column_mobile2',
				[
					'label' => esc_html__( 'Columns Mobile ( < 500px)', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '1',
					'options' => [
						'1' => esc_html__( '1', 'themesflat-core' ),
	        ...
	        $this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-next, {{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-prev' => 'font-size: {{SIZE}}{{UNIT}};',
					],
					'condition' => [
						'carousel' => 'yes',
	                    'carousel_arrow' => 'yes',
			...
			$this->add_responsive_control( 
				...
				[
					'label' => esc_html__( 'Horizontal Position Prev', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px', '%' ],
					'range' => [
						'px' => [
					...
					'selectors' => [
						'{{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-prev' => 'right: {{SIZE}}{{UNIT}};',
						'.rtl {{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-prev' => 'left: {{SIZE}}{{UNIT}};right: unset;',
					],
					'condition' => [
						'carousel' => 'yes',
	                    'carousel_arrow' => 'yes',
			...
			$this->add_responsive_control( 
				'carousel_arrow_horizontal_position2',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-next' => 'right: {{SIZE}}{{UNIT}};',
						'.rtl {{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-next' => 'left: {{SIZE}}{{UNIT}};right: unset;',
					],
					'condition' => [
						'carousel' => 'yes',
	                    'carousel_arrow' => 'yes',
			...
			$this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-next,{{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-prev' => 'top: {{SIZE}}{{UNIT}};',
					],
					'condition' => [
						'carousel' => 'yes',
	                    'carousel_arrow' => 'yes',
			...
			$this->start_controls_tabs( 
				...
				$this->add_control( 
		            ...
		            [
		                ...
		                'selectors' => [
							'{{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-next, {{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-prev' => 'color: {{VALUE}}',
						],
						'condition' => [
		                    'carousel_arrow' => 'yes',
		                ]
		    	...
		    	$this->add_control( 
		            ...
		            [
		                ...
		                'type' => \Elementor\Controls_Manager::COLOR,
		                'selectors' => [
							'{{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-next:hover, {{WRAPPER}} .tf-products.multirow .swiper-container .swiper-button-prev:hover' => 'color: {{VALUE}}'
						],
						'condition' => [
		                    'carousel_arrow' => 'yes',
		                ]
			...
			$this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tf-products.multirow .swiper-pagination' => 'left: {{SIZE}}{{UNIT}};',
					],
					'condition' => [
						'carousel' => 'yes',
			...
			$this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tf-products.multirow .swiper-pagination' => 'top: {{SIZE}}{{UNIT}};',
					],
					'condition' => [
						'carousel' => 'yes',
	                    'carousel_bullets' => 'yes',
			...
			$this->start_controls_tabs( 
				...
				$this->add_responsive_control( 
					'w_size_carousel_bullets',
						[
							...
							'selectors' => [
								'{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet' => 'width: {{SIZE}}{{UNIT}};',
							],
							'condition' => [
								'carousel' => 'yes',
								'carousel_bullets' => 'yes',
				...
				$this->add_responsive_control( 
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}};',
						],
						'condition' => [
							'carousel' => 'yes',
							'carousel_bullets' => 'yes',
				...
				$this->add_control( 
		            ...
		            [
		                ...
		                'type' => \Elementor\Controls_Manager::COLOR,
		                'selectors' => [
							'{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet' => 'background-color: {{VALUE}}',
						],
						'condition' => [
		                    'carousel_bullets' => 'yes',
		                ]
		        ...
		        $this->add_group_control( 
					...
					[
						...
						'selector' => '{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet',
						'condition' => [
		                    'carousel_bullets' => 'yes',
		                ]
					]
				...
				$this->add_responsive_control( 
		            ...
		            [
		                ...
		                'selectors' => [
		                    '{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		                ],
		                'condition' => [
		                    'carousel_bullets' => 'yes',
		                ]
				...
				$this->add_responsive_control( 
					'w_size_carousel_bullets2',
						[
							...
							'selectors' => [
								'{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'width: {{SIZE}}{{UNIT}};',
							],
							'condition' => [
								'carousel' => 'yes',
								'carousel_bullets' => 'yes',
				...
				$this->add_responsive_control( 
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}};',
						],
						'condition' => [
							'carousel' => 'yes',
							'carousel_bullets' => 'yes',
	        	...
	        	$this->add_control( 
		            ...
		            [
		                ...
		                'type' => \Elementor\Controls_Manager::COLOR,
		                'selectors' => [
							' {{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'background-color: {{VALUE}}',
						],
						'condition' => [
		                    'carousel_bullets' => 'yes',
		                ]
	        	...
	        	$this->add_group_control( 
					...
					[
						...
						'label' => esc_html__( 'Border', 'themesflat-core' ),
						'selector' => '{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active',
						'condition' => [
		                    'carousel_bullets' => 'yes',
		                ]
					]
				...
				$this->add_responsive_control( 
		            ...
		            [
		                ...
		                'size_units' => [ 'px', '%', 'em' ],
		                'selectors' => [
		                    '{{WRAPPER}} .tf-products.multirow .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		                ],
		                'condition' => [
		                    'carousel_bullets' => 'yes',
		                ]
	...
	protected function render($instance = []) {
		...
		$this->add_render_attribute( 'tf_posts', ['id' => "tf-products-{$this->get_id()}", 'class' => ['tf-products multirow', $settings['style'], $settings['posts_layout'],$settings['posts_layout_tablet'],$settings['posts_layout_mobile'], $has_carousel ], 'data-tabid' => $this->get_id()] );
		...
		if ( $query->have_posts() ) : ?>
			<div <?php echo $this->get_render_attribute_string('tf_posts'); ?>  data-arrow="<?php echo esc_attr($settings['carousel_arrow']) ?>" data-bullets="<?php echo esc_attr($settings['carousel_bullets']) ?>" >
				<?php if ( $settings['carousel'] == 'yes' ): ?>
					<div class="swiper-container product-test " data-row="<?php echo esc_attr($settings['carousel_row']); ?>"  data-column="<?php echo esc_attr($settings['carousel_column_desk2']); ?>" data-column2="<?php echo esc_attr($settings['carousel_column_tablet']) ?>" data-column3="<?php echo esc_attr($settings['carousel_column_mobile']) ?>" data-column4="<?php echo esc_attr($settings['carousel_column_mobile2']) ?>">
				...
				<?php if ( $settings['carousel'] == 'yes' ): ?>
					...
					<?php if ( $settings['carousel_bullets'] == 'yes'  ) : ?>
