...
class TFAccordion_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        // Start Accordion        
	        ...
	        $repeater = new \Elementor\Repeater();
				$repeater->add_control( 'icon_accodion_content',
					[
						'label' => esc_html__( 'Icon', 'themesflat-core' ),
						'type' => \Elementor\Controls_Manager::ICONS,
						'fa4compatibility' => 'fa-quote-left',
						'default' => [
		        ...
		        $repeater->add_control( 'list_title', [
						...
						'default' => esc_html__( '1. What canIdo ifIforgot my password?' , 'themesflat-core' ),
						'label_block' => true,
					]
				);
				...
				$repeater->add_control( 'list_content', [
						...
						'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam.' , 'themesflat-core' ),
						'label_block' => true,
						'condition' => [
				...
				$repeater->add_control( 'list_content_template',
					[
						...
						'type' => \Elementor\Controls_Manager::SELECT,
						'options' => ThemesFlat_Addon_For_Elementor_core::tf_get_template_elementor(),
						'condition' => [
		        ...
		        $this->add_control( 'accordion_list',
					[					
						...
						'default' => [
							[	
								'set_active' => 'inactive',
								'list_title' => esc_html__( '1. What canIdo ifIforgot my password?', 'themesflat-core' ),
								'list_content' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '2. Why cannotIreceive the SMS verification code?', 'themesflat-core' ),
								'list_content' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '3. When willIreceive my order?', 'themesflat-core' ),
								'list_content' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam." ),
							],
							[
								'set_active' => 'active',
								'list_title' => esc_html__( '4. How canIregister an account', 'themesflat-core' ),
								'list_content' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '5. What can I do if my account was deactivated?', 'themesflat-core' ),
								'list_content' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '6. How do I add the inspection service to my Trade Assurance order?', 'themesflat-core' ),
								'list_content' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '7. How doIdelete verification phone number?', 'themesflat-core' ),
								'list_content' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '8. How doIleave feedback for my order?', 'themesflat-core' ),
								'list_content' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac tortor sit amet est egestas lacinia vitae sit amet sem. Aliquam fringilla ex at lorem faucibus auctor. Duis sollicitudin nec nunc vitae interdum. Maecenas a tempus quam. Suspendisse sit amet erat vehicula, fermentum ipsum sit amet, tincidunt sapien. Duis scelerisque quis ligula et fermentum. Donec id finibus neque, in commodo diam." ),
							],
						],
		...
		// Start General Style 
			...
			$this->add_control( 'title_style',
					[
						'label' => esc_html__( 'Style', 'onsus' ),
						'type' => \Elementor\Controls_Manager::SELECT,
						'default' => 'style1',
						'options' => [
							'style1'  => esc_html__( 'style 1', 'onsus' ),
							// 'style2'  => esc_html__( 'style 2', 'onsus' ),
						],	
					]
				);	
	...
	protected function render($instance = []) {
		...
		$accordion_item = $html_title = $icon_title = $icon_accodion_close = $icon_accodion_open = $icon_accodion_right_close = $icon_accodion_right_open = $html_content = $set_active = $icon_accodion_content = '';	
		...
		foreach ($settings['accordion_list'] as $key => $value) {
			...
			if ( $settings['icon_style'] == 'icon' ) {
				if ( $settings['icon_position'] == 'icon_before' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_close =  \Elementor\Addon_Elementor_Icon_manager::render_icon( $settings['icon_accodion'] );
				}
				if ( $settings['icon_position'] == 'icon_after' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_right_close =  \Elementor\Addon_Elementor_Icon_manager::render_icon( $settings['icon_accodion_right'] );
				}

				if ( $settings['icon_position'] == 'icon_before' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_open =  \Elementor\Addon_Elementor_Icon_manager::render_icon( $settings['icon_accodion_active'] );
				}
				if ( $settings['icon_position'] == 'icon_after' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_right_open =  \Elementor\Addon_Elementor_Icon_manager::render_icon( $settings['icon_accodion_right_active'] );
				}
			...
			if ( $value['list_content_text_type'] == 'template' ) {
				...
				$icon_accodion_content =  \Elementor\Addon_Elementor_Icon_manager::render_icon( $value['icon_accodion_content'] );
				$html_content = sprintf('<div class="accordion-content">%1$s <span>%2$s</span></div>',$icon_accodion_content, do_shortcode( $value['list_content'] ));
			}			
