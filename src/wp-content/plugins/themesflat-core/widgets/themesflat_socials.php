...
class themesflat_socials extends WP_Widget {
        ...
        <div class="themesflat_widget_socials themesflat-options-control-social-icons">
            <ul class="themesflat_icons">
                <li class="item-properties">
                    ...
                    <button type="button" class="button button-primary confirm"><i class="icon-monal-check-mark"></i></button>
                </li>
    ...
    function themesflat_available_social_icons_widget() {
        $icons = apply_filters( 'themesflat_available_icons', array(
            ...
            'twitter-2'        => array( 'iclass' => 'icon-monal-icon10', 'title' => 'Twitter','share_link' => THEMESFLAT_PROTOCOL . '://twitter.com/intent/tweet?url=' ),
            ...
            'facebook-2'       => array( 'iclass' => 'icon-monal-facebook2', 'title' => 'Facebook','share_link'=> THEMESFLAT_PROTOCOL . '://www.facebook.com/sharer/sharer.php?u=' ),
            ...
            'instagram-2'      => array( 'iclass' => 'icon-monal-icon11', 'title' => 'Instagram','share_link' => 'https://www.instagram.com/?url=' ),
            ...
            'spotify'        => array( 'iclass' => 'icon-monal-spotify', 'title' => 'Spotify','share_link' => ''),
            ...
            'linkedin-2'          => array( 'iclass' => 'icon-monal-icon12', 'title' => 'Steam','share_link' => ''),
            'linkedin-3'          => array( 'iclass' => 'icon-monal-linkedin2', 'title' => 'Linkedin','share_link' => ''),
        ) );
