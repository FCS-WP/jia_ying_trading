...
class Themesflat_Services_Categories extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_categories',
            esc_html__( 'Themesflat - Services Categories', 'themesflat-core' ),
            array(
                'classname'   => 'widget_categories',
                'description' => esc_html__( 'Services Categories.', 'themesflat-core' )
            )
        );
    }
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'custom_ids' ) ); ?>"><?php esc_html_e( 'Custom Categories By Ids- EX: 1,2,3', 'themesflat-core' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'child_of' ) ); ?>"><?php esc_html_e( 'Child Of:', 'themesflat-core' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_count' ) ); ?>"><?php esc_html_e( 'Show count?', 'themesflat-core' ); ?></label>
        </p>
    <?php
    }
}
