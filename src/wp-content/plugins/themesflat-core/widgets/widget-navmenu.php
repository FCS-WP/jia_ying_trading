...
class TFNavMenu_Widget_Free extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        // Start Menu Settings        
			...
			$this->add_control( 'title', [
				...
				'default' => esc_html__( 'All Departments' , 'themesflat-core' ),
				'label_block' => true,
			]
			);
        ...
        // Start Main Menu Style 
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tf-nav-menu .mainnav .menu-container > ul > li' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}};',
					],
				]
			);
	...
	protected function render($instance = []) {
		...
		if ($settings['nav_menu_logo']['url']) {
		 ...
		 if ( $settings['title'] != '' ) {
			$title = '<h3 class="title">' . esc_attr($settings['title']). '</h3>';
		 }
