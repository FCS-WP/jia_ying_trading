		...
		// Start List Setting        
	        ...
	        $this->add_control( 
				...
				[
					...
					'options' => ThemesFlat_Addon_For_Elementor_core::tf_get_taxonomies_product(),
					'label_block' => true,
	                'multiple' => true
				]
			);
