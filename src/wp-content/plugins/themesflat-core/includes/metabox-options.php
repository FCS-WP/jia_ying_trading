...
function themesflat_page_options_init() {
 ...
 //    	'id'	 => 'portfolio-options',
	// 	'label'  => esc_html__( 'Causes Settings', 'themesflat-core' ),
	// 	'post_types'  => 'portfolios',
	//     'context'     => 'normal',
 //        'priority'    => 'default',
	// 	'sections' => array(
 //            'general'   => array( 'title' => esc_html__( 'Portfolio', 'themesflat-core' ) ),
	// 		),
...
//         'default' => '',
//         'type'    => 'text',
//         'title'   => esc_html__( 'Status', 'themesflat-core' )
//     );
...
//         'default' => '',
//         'type'    => 'text',
//         'title'   => esc_html__( 'Name Client', 'themesflat-core' )
//     );
...
//         'default' => '',
//         'type'    => 'text',
//         'title'   => esc_html__( 'Url Client', 'themesflat-core' )
//     );
//     return $options;
// }