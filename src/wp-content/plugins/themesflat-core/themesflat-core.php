...
$theme = wp_get_theme();
if ( 'Onsus' == $theme->name || 'Onsus' == $theme->parent_theme ) {
    ...
    require THEMESFLAT_PATH . "/widgets/themesflat_filter.php";
    require THEMESFLAT_PATH . "/widgets/themesflat_filter_rating.php";
    require THEMESFLAT_PATH . "/widgets/themesflat_filter_price.php";
    require THEMESFLAT_PATH . "/widgets/themesflat_category.php";
}
...
final class ThemesFlat_Addon_For_Elementor_core {
    ...
    public function init_widgets() {
        ...
        if ( class_exists( 'woocommerce' ) ) { 
            ...
            \Elementor\Plugin::instance()->widgets_manager->register( new \TFWooCategory_Widget() );

            require_once( __DIR__ . '/widgets/widget-woo-products-banner.php' );
            \Elementor\Plugin::instance()->widgets_manager->register( new \TFWooProductsBanner_Widget() );

            
            require_once( __DIR__ . '/widgets/widget-products.php' );
            \Elementor\Plugin::instance()->widgets_manager->register( new \TFProduct_Widget() );

            require_once( __DIR__ . '/widgets/widget-products-single.php' );
            \Elementor\Plugin::instance()->widgets_manager->register( new \TFProductSingle_Widget() );

            require_once( __DIR__ . '/widgets/widget-products-multi-row.php' );
            \Elementor\Plugin::instance()->widgets_manager->register( new \TFProductMultiRow_Widget() );
            require_once( __DIR__ . '/widgets/widget-product-tabs.php' );
            \Elementor\Plugin::instance()->widgets_manager->register( new \TFProductTabs_Widget() );
            
            require_once( __DIR__ . '/widgets/widget-product-tabs-single.php' );
            \Elementor\Plugin::instance()->widgets_manager->register( new \TFProductTab_Widget() );
        }
    ...
    public function widget_styles() {
        ...
        wp_register_style( 'swiper-min', plugins_url( '/assets/css/swiper-bundle.min.css', __FILE__ ) );
        ...
        // wp_enqueue_style( 'users', plugins_url( '/assets/css/user.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-product-single', plugins_url( '/assets/css/product-single/tf-product-single.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-nav-menu', plugins_url( '/assets/css/nav-menu/nav-menu.css', __FILE__ ) );
    ...
    public function widget_scripts() {
        ...
        wp_register_script( 'swiper-min', plugins_url( '/assets/js/swiper-bundle.min.js', __FILE__ ), [ 'jquery' ], false, true );
        ...
        wp_register_script( 'tf-tab', plugins_url( '/assets/js/tabs-single/tf-tabs-single.js', __FILE__ ), [ 'jquery' ], false, true );
        ...
        wp_register_script( 'tf-product-single', plugins_url( '/assets/js/product-single/tf-product-single.js', __FILE__ ), [ 'jquery' ], false, true );
        wp_register_script( 'tf-product-category', plugins_url( '/assets/js/product-category/tf-product-category.js', __FILE__ ), [ 'jquery' ], false, true );
      
        wp_register_script( 'tf-video', plugins_url( '/assets/js/video/tf-video.js', __FILE__ ), [ 'jquery' ], false, true );
        wp_register_script( 'tf-nav-menu', plugins_url( '/assets/js/nav-menu/nav-menu.js', __FILE__ ), [ 'jquery' ], false, true );
        ...
        wp_enqueue_script( 'bootstrap', plugins_url( '/assets/js/bootstrap.bundle.min.js', __FILE__ ), [ 'jquery' ], false, true );
        wp_enqueue_script( 'bootstrap-min', plugins_url( '/assets/js/bootstrap.min.js', __FILE__ ), [ 'jquery' ], false, true );
        wp_enqueue_script( 'validate', plugins_url( '/assets/js/jquery.validate.min.js', __FILE__ ), [ 'jquery' ], false, true );        
        wp_enqueue_script( 'tf-user', plugins_url( '/assets/js/user.js', __FILE__ ), [ 'jquery' ], false, true );
    ...
    public function admin_scripts() {
        ...
        wp_localize_script( 'user', 'ajax_object', $user_vars ); 
    ...
    ========================================= */
        ...
        public static function get_template_id( $type ) {
            ...
            $tfhf_templates = ThemesFlat_Addon_For_Elementor_core::instance()->get_posts_by_conditions( 'tf_header_footer', $option );
...
ThemesFlat_Addon_For_Elementor_core::instance();