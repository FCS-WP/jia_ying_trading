                        ...
                        <main id="main" class="main-content" role="main"> 
                            <?php
                                ...
                                if ( $show_filter == 1 ) {  
                                    ...
                                    echo '<ul class="services-filter posttype-filter"><li class="active"><a data-filter="*" href="#">' . esc_html__( 'All', 'themesflat-core' ) . '</a></li>'; 
                                    ...
                                    while ( $query->have_posts() ) : $query->the_post();                	
                                        ...
                                        <div class="item <?php echo esc_attr( $termsString ); ?>">
                                            <div class="services-post services-post-<?php the_ID(); ?>">
                                                ...
                                                <div class="content"> 
                                                    <?php 
                                                    $services_post_icon  = \Elementor\Addon_Elementor_Icon_manager::render_icon( themesflat_get_opt_elementor('services_post_icon'), [ 'aria-hidden' => 'true' ] );
                                                    ...
                                                    <div class="tf-button-container">
                                                        <a href="<?php echo esc_url( get_permalink() ); ?>" class="tf-button bt_icon_after"><?php esc_html_e('Read More', 'themesflat-core') ?> <i class="fas fa-arrow-right"></i></a>
                                                    </div>
