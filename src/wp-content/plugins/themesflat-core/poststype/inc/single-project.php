								...
								<div class="meta-post">
									<div class="inner-meta-post">
										<div class="meta-post-item meta-post-info">
											<h4 class="meta-post-title"><?php esc_html_e('Project Info','themesflat-core') ?></h4>
											<div class="meta-post-content"><?php the_field('project_info', get_the_ID()); ?></div>
										</div>

										<div class="meta-post-item meta-post-category">
											<h4 class="meta-post-title"><?php esc_html_e('Category','themesflat-core') ?></h4>
										...
										<div class="meta-post-item meta-post-date">
											<h4 class="meta-post-title"><?php esc_html_e('Date','themesflat-core') ?></h4>
		...
		if ( $terms != '' ){
			...
			<div class="related-post related-posts-box">
			    <div class="box-wrapper">
			        <h3 class="box-title"><?php esc_html_e( 'Related Projects', 'themesflat-core' ) ?></h3>
