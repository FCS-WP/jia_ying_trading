                        ...
                        <div class="themesflat-options-control-inputs">
                            <div class="upload-dropzone">  
                                ...
                                <span class="upload-message <?php echo esc_attr($showupload);?> ">
                                    <a href="#" class="browse-media"><?php esc_html_e( 'Add file', 'themesflat-core' ) ?></a>
                                    <a href="#" class="upload"></a>
                                </span>
                            </div>
                            <a href="#" class="button remove <?php echo esc_attr($showremove);?>"><?php esc_html_e( 'Remove', 'themesflat-core' ) ?></a>
                        </div>
                    ...
                    <span class="themesflat-options-control-title"><?php TF_Post_Format::themesflat_esc_html($title);?></span>
                        <div class="themesflat-options-control-inputs">
                            <div class="upload-dropzone">
                                ...
                                <span class="upload-message <?php echo esc_attr($showupload);?> ">
                                    <a href="#" class="browse-media"><?php esc_html_e( 'Add files', 'themesflat-core' ) ?></a>
                                    <a href="#" class="upload"></a>
                                </span>
                            </div>
                            <a href="#" class="button remove <?php echo esc_attr($showremove);?>"><?php esc_html_e( 'Remove', 'themesflat-core' ) ?></a>
