            ...
            <div class="item <?php echo esc_attr( $termsString ); ?>">
                <div class="portfolios-post portfolios-post-<?php the_ID(); ?>">
                    ...
                    <div class="content">
                        ...
                        <a href="<?php echo get_the_permalink(); ?>"><?php echo '<div class="icon">'.\Elementor\Addon_Elementor_Icon_manager::render_icon( $settings['post_icon_readmore'], [ 'aria-hidden' => 'true' ] ).'</div>';?></a>
