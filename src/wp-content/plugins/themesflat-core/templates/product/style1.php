...
if($product_type === 'variable'){
    ...
    // $sale_price1 = get_post_meta( get_the_ID(), '_sale_price', true);
    // if (isset($sale_price) && $sale_price != 0 && isset($regular_price) && $regular_price != 0 ) {
    //     $product_save = ( $regular_price1 > 0 ? round($regular_price1 - $sale_price1) : 0 );
    // }
    ...
    <div class="ounner">
        <div class="inner">
            ...
            <div class="image">
                ...
                <?php if ( isset($sale_price) && $sale_price != 0 && $regular_price != 0 ) { ?>
                ...
                <?php if ( $settings['show_group_btn'] == 'yes' ): ?>
            ...
            <div class="content">
                ...
                <div class="price"><?php  echo str_replace(""," ",$product->get_price_html()); ?>
            
                <?php if ( $settings['show_save_price'] == 'yes' ): ?> 
                <?php if (isset( $sale_price) &&  $sale_price != 0) {?> <div class="price-save"><?php echo esc_html__( 'Save:$', 'themesflat-core' ).$product_save ?></div> <?php } ?>
                <?php endif; ?> 

                </div>
                <?php endif; ?> 

                <?php if ( $settings['show_coutdown'] == 'yes' ): ?>
                <?php
                ...
                <?php if ( $settings['show_skillbar'] == 'yes' ): ?>
