				...
				<div id="primary" class="content-area">
					...
					<main id="main" class="post-wrap" role="main">
						...
						<?php if (!is_shop() && is_product_category()) {
							echo do_shortcode('[elementor-template id="6250"]');
						} ?>
									...
									<?php if (themesflat_get_opt('catalog_toolbar') == 1) { ?>
										<div class="row">
											<div class="left-top-shop-loop col-lg-6 col-12">
												...
												?>
												<span class="filter-button btn-des"><svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="margin-right:5px">
													...
													</svg><?php esc_html_e('Filter', 'onsus') ?></span>
											...
											<div class="center-top-shop-loop col-lg-6 col-md-12 col-12">
												...
												<div class="wrap-toggle-products-layout">
													<span class="filter-button"><svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="margin-right:5px">
															<path d="M3.9 54.9C10.5 40.9 24.5 32 40 32H472c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9V448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6V320.9L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z"></path>
														</svg><?php esc_html_e('Filter', 'onsus') ?></span>
